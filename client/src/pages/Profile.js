...
// Redirect allows the user to be redirected to another route within the app
...
const Profile = props => {
  ...
  //is used to run the QUERY_USER query. If there's no value in userParam, QUERY_ME
